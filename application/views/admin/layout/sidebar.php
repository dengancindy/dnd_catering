...
<html lang="en">
  <head>
    ...
    <title>DnD Catering | Dashboard Admin</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-home"></i> <span>DnD Catering</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo site_url('kategori'); ?>">
                    <i class="fa fa-home"></i> Data Kategori</a>
                  </li>
                  <li><a href="<?php echo site_url('paketmenu'); ?>">
                    <i class="fa fa-group"></i> Data Paket Menu</a>
                  </li>
                  <li><a href="<?php echo site_url('datapembeli'); ?>">
                    <i class="fa fa-group"></i> Data Pembeli</a>
                  </li>
                  <li><a href="<?php echo site_url('pesanan'); ?>">
                    <i class="fa fa-group"></i> Data Pesanan</a>
                  </li>
